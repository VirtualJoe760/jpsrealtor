...
closed_collection = db.gpsClosedListings  # Collection for closed/sold listings
...
def main():
    ...
    # Summary
    print(f"\n🏁 Done! {changed} listings updated, {sold} sold (moved to closed), {removed} off-market, checked {checked} total.")
    log = {
