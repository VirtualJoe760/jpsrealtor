...
export async function generateMetadata() {
  return {
    ...
    twitter: {
      ...
      images: ["https://res.cloudinary.com/duqgao9h8/image/upload/f_auto,q_auto/jpsrealtor/misc/real-estate/front-yard/front-yard_00001_.png"], // Replace with the full URL if hosted externally
    },
    robots: {
      index: true,
      follow: true,
...
export default function OpenHouseSignupPage() {
  ...
  return (
    <div className="bg-black text-white min-h-screen flex flex-col">
      {/* Hero Section */}
      <VariableHero
        backgroundImage="https://res.cloudinary.com/duqgao9h8/image/upload/f_auto,q_auto/jpsrealtor/misc/real-estate/front-yard/front-yard_00001_.png" // Replace with your actual default hero image path
