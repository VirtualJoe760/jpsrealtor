  ...
  return (
    <div className="relative px-6 pb-12 pt-12 lg:static">
      <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
        <h2 className={`text-pretty text-4xl font-semibold tracking-tight sm:text-5xl ${textPrimary}`}>
          Let&apos;s Connect
        </h2>
        <p className={`mt-6 md:text-lg sm:text-base ${textSecondary}`}>
        ...
        <dl className={`mt-10 space-y-4 text-base/7 ${textSecondary}`}>
          {/* Address */}
          <div className="flex gap-x-4">
            <dt>
              <BuildingOffice2Icon className={`h-7 w-6 ${textMuted}`} aria-hidden="true" />
            </dt>
            <dd>
              <Link
                ...
                className={isLight ? "hover:text-gray-800" : "hover:text-gray-300"}
              >
                36923 Cook St B101
                <br />
          ...
          <div className="flex gap-x-4">
            <dt>
              <EnvelopeIcon className={`h-7 w-6 ${textMuted}`} aria-hidden="true" />
            </dt>
            <dd>
              <Link href="mailto:josephsardella@gmail.com" className={isLight ? "hover:text-gray-800" : "hover:text-gray-300"}>
