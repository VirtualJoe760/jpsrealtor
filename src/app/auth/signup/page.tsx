          ...
          <div className={`shadow-2xl rounded-2xl border p-8 ${
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full py-3 px-4 bg-[#1877F2] hover:bg-[#166FE5] text-white font-semibold rounded-lg shadow-lg transition-all duration-200 flex items-center justify-center gap-3"
              >
