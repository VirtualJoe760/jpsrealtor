...
// PUT - Update user's email signature (from settings page)
export async function PUT(req: NextRequest) {
  try {
    ...
    const { emailSignature } = await req.json();
    ...
    // Update signature - store as object matching schema
    user.emailSignature = {
      html: emailSignature || '',
      photo: null, // Photo support can be added later
    };
