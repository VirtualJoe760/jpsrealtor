...
export const update_landing_page: ToolDef = {
  name: "update_landing_page",
  description:
    "Update a DRAFT landing page. Fields are all optional — only what you pass gets changed. Refuses to touch published pages (HTTP 409); the agent has to take a published LP back to draft in the CMS first. Same field shape as create_landing_page, no slugId in the body — slugId is the URL param.",
  inputSchema: {
    type: "object",
    properties: {
      slugId: { type: "string" },
