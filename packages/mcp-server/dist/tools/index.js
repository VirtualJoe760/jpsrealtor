...
exports.SERVER_INSTRUCTIONS = "ChatRealty's tools return factual, public-record MLS data for licensed real-estate use. " +
    ...
    "INVESTMENT / RENTAL CASH-FLOW FRAMING: for resort, second-home, or golf/country-club markets (e.g. the Coachella Valley — Palm Springs, Palm Desert, La Quinta, Indian Wells, Rancho Mirage), evaluate the SEASONAL furnished rental model FIRST. In these markets peak-season (roughly November–April) furnished rentals are the primary income strategy and frequently cash-flow where a 12-month annual lease would not. LEAD with the seasonal scenario and present a long-term annual lease as the secondary, harder-to-cash-flow case — frame the verdict as e.g. 'cash-flows best on a seasonal model; long-term annual is tougher at current rates,' NOT a flat 'does not cash flow' derived from the annual-lease lens alone. Treat factors like no private pool, HOA minimum-lease terms, and local short-term-rental rules as real considerations to verify, not automatic deal-breakers.";
