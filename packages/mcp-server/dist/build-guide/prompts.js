...
exports.BUILD_GUIDE_PROMPTS = [
    {
        ...
        body: [
            ...
            "   - If I don't: explain how agents get one (your MLS or association's data-services / IDX / RESO Web API application) and offer to draft that request with me. Then stop — never build against empty data, never scrape, never invent listings, never build a local stand-in database.",
