...
exports.BUILD_GUIDE_PROMPTS = [
    ...
    },
    {
        ...
        body: [
            ...
            "   (a) MY BUSINESS — plain questions: do I go by my own name ('Jane Smith, Real Estate Agent') or a team/group name? Must-haves you cannot build without: license ID number, brokerage, team name if one exists, the market I serve, and the phone/email that belong in the footer. These are exactly the fields that live in my ChatRealty settings — collect what's missing and, at the end of the build, remind me to save them to my ChatRealty profile so everything stays in sync.",
            ...
            "   (d) BRAND BASICS — colors if I have them, a logo file if one exists, and one feel word (elegant / warm / bold / minimal / editorial). Deeper design choices happen in the design step against real visuals, not as more questions here.",
    ...
    },
    {
        ...
        body: [
            ...
            "",
            "1. The scaffold step already collected my business details, feature checklist, homepage checklist, and brand basics — do NOT re-ask any of it. This step goes DEEPER on look and feel, and the best questions here are reactions to something visible: propose, then let me pick. If the scaffold-step answers are somehow missing, collect them now (its checklists), before showing any un-designed page.",
