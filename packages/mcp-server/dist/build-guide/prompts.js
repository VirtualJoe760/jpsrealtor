...
exports.BUILD_GUIDE_PROMPTS = [
    {
        ...
        summary: "ChatRealty is bring-your-own-data — confirm YOUR tenant database is connected, or start the data-key conversation (serverless: the site syncs itself via an hourly cron, no VPS).",
        order: 1,
        body: [
    ...
    },
    {
        ...
        summary: "Four interactive questions, then build — the first site the agent sees is already THEIRS, never the neutral wireframe. Compliance and brand details are collected at the reveal, not up front.",
        order: 2,
        body: [
