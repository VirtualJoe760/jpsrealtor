...
export const DATA_DICTIONARY_VERSION = "2026-06-25.1";
function field(name, resoName, pgColumn, type, overrides = {}) {
    return {
        name,
        resoName,
        pgColumn,
...
const PROPERTY_FIELDS = [
    ...
    field("poolYN", "PoolPrivateYN", "pool_yn", "boolean", {
        indexed: true,
        description: "Canonical pool flag. Sync MUST normalize poolYn/poolYN/pool to this one column (build_plan §6.5 — Beverly Hills 0%-vs-73% defect).",
    }),
    ...
    field("onMarketDate", "OnMarketDate", "on_market_date", "date", {
        indexed: true,
        description: "On-market timestamp. The Mongo path stores this as an ISO string and compares lexically (StrRange trap); Postgres stores a real timestamptz.",
    }),
    ...
    field("listAgentName", "ListAgentFullName", "list_agent_name", "string", {
        nullable: false,
        required: true,
        description: "ATTRIBUTION (§3.8). From ListAgentFullName. Required on every listing surface.",
    }),
...
export function fieldNameToColumn(resource, name) {
